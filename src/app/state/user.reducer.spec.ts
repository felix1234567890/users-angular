...
describe('userReducer', () => {
    ...
    it('should shuffle and set users, sortedUsers, and loading to false on loadUsersSuccess action', () => {
        const users: User[] = [
            { name: 'User 1', age: 25, gender: 'Male', country: 'USA', email: 'user1@example.com', photo: 'user1.jpg' },
            { name: 'User 2', age: 30, gender: 'Female', country: 'UK', email: 'user2@example.com', photo: 'user2.jpg' },
